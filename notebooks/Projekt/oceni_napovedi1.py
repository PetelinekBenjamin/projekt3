...
with mlflow.start_run():
    mlflow.set_tag('ovrednotenje_proizvodnja1', 'true')  # Dodajanje taga 'ovrednotenje1'
...
error_df.to_csv('data/processed/prediction_errors1.csv', index=False)
metrics_df.to_csv('data/processed/prediction_metrics1.csv', index=False)


# Preberite metrike iz najnovejšega teka z tagom 'ovrednotenje1'
latest_run = mlflow.search_runs(filter_string="tags.ovrednotenje_proizvodnja1 = 'true'", order_by=["start_time DESC"], max_results=1)
