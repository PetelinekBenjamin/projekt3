...
db = client.metrike
collection = db.ovrednotenje_model2
...
with mlflow.start_run():
    mlflow.set_tag('ovrednotenje_proizvodnja2', 'true')  # Dodajanje taga 'ovrednotenje1'
...
error_df.to_csv('data/processed/prediction_errors2.csv', index=False)
metrics_df.to_csv('data/processed/prediction_metrics2.csv', index=False)


# Preberite metrike iz najnovejšega teka z tagom 'ovrednotenje1'
latest_run = mlflow.search_runs(filter_string="tags.ovrednotenje_proizvodnja2 = 'true'", order_by=["start_time DESC"], max_results=1)
